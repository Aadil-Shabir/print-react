...
export default function ViewReport({
  ...
  return (
    <Flex w='full' h='100vh' justify='space-between'>
      <Flex></Flex>
      <Flex flexDirection='column' w='full' p={3} justify='center'>
        ...
        <div className='overflow-y-auto scrollbar-hide'>
          ...
          <Flex w='full' justify='space-between' align='center' mb={2}>
            <Flex w='150px'>
              ...
              {wellType === 'PCP Oil Producer' && (
                <Image src='/pcp-oil-producer.svg' alt='pcp' boxSize='60px' />
              )}
          ...
          <Flex w='full' bg={sectionBg} justify='center' align='center' mb={2}>
          ...
          <Flex w='full' bg={sectionBg} justify='center' align='center' my={2}>
            <Text fontSize='xs' fontWeight='bold'>
              Equipment
            </Text>
          </Flex>
          {equipment?.map((item, index) => (
            <Flex w='full' justify='space-between' align='center' key={index}>
              <Flex>
                <Flex w='16px'>
                  <Text fontSize='xs'>{index + 1}</Text>
                </Flex>
          ...
          <Flex w='full' bg={sectionBg} justify='center' align='center' my={3}>
            <Text fontSize='xs' fontWeight='bold'>
              Sequence of Events
            </Text>
          </Flex>
